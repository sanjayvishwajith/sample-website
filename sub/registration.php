...
username : <input type="text" name="user" class="form-control" required><br><br>
...
<button type="button" onclick="window.location.href = 'signin.php';"> go back to login page</button><br><br><br>
</form>
